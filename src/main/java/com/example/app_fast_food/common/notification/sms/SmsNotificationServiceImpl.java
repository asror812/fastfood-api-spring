...
import com.example.app_fast_food.common.notification.eskiz.EskizFeignClient;
...
public class SmsNotificationServiceImpl implements SmsNotificationService {
    ...
    public void sendNotification(String phoneNumber, String message) {
        try{
            ...
            log.error("Exception occurred while sending notification.phoneNumber {}  message  {}  " , phoneNumber, message, e );
        }
    }
}
