...
public class DatabaseInitializer implements CommandLineRunner {
        ...
        private BonusProductLink link(Bonus bonus, Product product, int qty) {
                return new BonusProductLink(bonus, product, qty);
        }
        ...
        private void addProductImage(Product product, String baseName, String type, int position) {
                ...
                ProductImage image = new ProductImage(product, attachment, position);
        ...
        private void createUsers() {
                if (userRepository.findAll().isEmpty()) {
                        ...
                        // TEST USER
                        User user = new User("+976750812", "r1", passwordEncoder.encode("11111111"),
        ...
        private void createRoles() {
                createRoleIfMissing(CUSTOMER, Set.of(
                                "CART_MANAGE", "ORDER_CREATE", "ORDER_READ_OWN", "ORDER_CANCEL_OWN",
                                "FAVORITE_MANAGE", "PROFILE_MANAGE"));

                createRoleIfMissing(COURIER, Set.of(
                                "DELIVERY_READ_ASSIGNED", "DELIVERY_STATUS_UPDATE"));

                createRoleIfMissing(STAFF, Set.of(
        ...
        private void createRoleIfMissing(String roleName, Set<String> permissionNames) {
                ...
                Set<Permission> perms = permissionRepository.findAllByNameIn(permissionNames);
                roleRepository.save(new Role(roleName, perms));
        }
